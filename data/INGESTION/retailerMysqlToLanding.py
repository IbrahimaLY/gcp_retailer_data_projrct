...
# MySQL Configuration
MYSQL_CONFIG = {
    "url": "jdbc:mysql://104.197.57.67:3306/retailerDB?useSSL=false&allowPublicKeyRetrieval=true",
...
def extract_and_save_to_landing(table, load_type, watermark_col):
    try:
        ...
        JSON_FILE_PATH = f"landing/retailer-db/{table}/{today}/{table}_{today}.json"
